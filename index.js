...
const io = socketIo(server, {
  cors: {
    origin: 'http://localhost:3000, https://pm-2.netlify.app/', // Allow all origins for development
...
app.use(cors({
    origin: 'http://localhost:3000, https://pm-2.netlify.app/',  // Allow all origins
